...
# Constants
FILE_SIZE_LIMIT = 1e+8 # (In Bytes, 1/10 of a gigabyte)
...
async def upload_proxy(
    ...
    is_in_bucket = download_from_minio(file.filename, BUCKET_NAME) # TODO: Replace this with something more efficient later on
    if is_in_bucket:
